        ...
        <section className="max-w-7xl mx-auto px-6">
          ...
          <section className="max-w-5xl mx-auto text-center mb-20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-5">
              ...
              <img src="/unidad.jpeg" alt="" className="rounded-2xl shadow-lg hover:scale-105 transition h-40 w-full object-cover" />
              ...
              <img src="/ov4.jpeg" alt="" className="rounded-2xl shadow-lg hover:scale-105 transition h-40 w-full object-cover" />
              <img src="/uni3.jpeg" alt="" className="rounded-2xl shadow-lg hover:scale-105 transition h-40 w-full object-cover" />
